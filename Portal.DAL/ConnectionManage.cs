	...
	public class ConnectionManage
	{
		private static SqlConnection MyConnection
		{
			get
			{
				...
				SqlConnection aa = (SqlConnection)currentConnectionObj;
				//aa.State == ConnectionState.
		...
		{
			SqlCommand myCommand = new SqlCommand(sqlStored, (transactional) ? GetConnection : GetNewConnection);
		...
		public static DataTable DoStoredTable(string sqlStored, DbSqlParameterCollection sqlParams)
		{
			...
			SqlCommand myCommand = new SqlCommand(sqlStored, (isTransaction) ? GetConnection : GetNewConnection);
			myCommand.CommandType = CommandType.StoredProcedure;
			foreach (DbSqlParameter p in sqlParams)
			{
				myCommand.Parameters.Add(p.Parameter);
		...
		public static string Connection
		{
			...
			{
				if (connection == null)
					connection = System.Configuration.ConfigurationManager.ConnectionStrings["PortalConnectionStr"].ConnectionString as string;
				return connection;
			}
		}
		//public static bool needTransaction = false;
