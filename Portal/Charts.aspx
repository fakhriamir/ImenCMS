<%@ Page Title="" EnableViewState="false" Language="C#" MasterPageFile="~/Pages.master"	AutoEventWireup="true" CodeBehind="Charts.aspx.cs" Inherits="Portal.Charts" %>
...
.filetree span.file { background: url(rtl-file.gif) 100% 0 no-repeat; }
	...
	<%=HttpContext.GetGlobalResourceObject("resource", "Def_Chart_Title").ToString()%>
	<%=Tools.Template.GetCadr(Tools.Template.CadrItem.CadrAfterTitle,0)%>
	<%--<asp:Image ID="CharImage" runat="server" />--%>
	<%--<div style="text-align: right">
		<asp:TreeView ID="MyTreeView" runat="server" OnTreeNodePopulate="Mytree_TreeNodePopulate">
		</asp:TreeView>
	</div>--%>
	<div id="main">
