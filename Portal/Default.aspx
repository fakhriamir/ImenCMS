<%@ Page Title="" EnableViewState="false" Language="C#" MasterPageFile="~/View.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Portal.MyDefault" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MyHead" runat="server">
	<%=Tools.Tools.GetSetting(356, "")%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MyBody" runat="server">
	<%if (Tools.Tools.ConvertToInt32(Portal.Global.MyDefaultType) < 0)
   {%>
	<asp:PlaceHolder ID="CustomPH" runat="server"></asp:PlaceHolder>
	<%}
   else
   { %>
	<%if (Portal.Global.MyDefaultType != "3")
   {%>
	<table id="DefTable" border="0" <%=Tools.Tools.GetSetting(434,"style=\"width: 100%\"  cellpadding=\"3\" cellspacing=\"0\"")%> >
		<tr>
			<td valign="top" colspan="3" align="center">
				<asp:PlaceHolder ID="DL12" EnableViewState="False" runat="server"></asp:PlaceHolder>
			</td>
		</tr>
		<%if (Portal.Global.MyDefaultType == "0")
	{ %>
		<tr>
			<td>
		...
		<%}
	else if (Portal.Global.MyDefaultType == "1")
	{%>
		<tr>
		...
		<%}
	else if (Portal.Global.MyDefaultType == "2")
	{%>
		<tr>
	...
	<%}
   else if (Portal.Global.MyDefaultType == "3")
   {%>
	<table  id="DefTable" border="0" cellspacing="1" style="width: 100%" align="center">
		<tr>
