<%@ Page Title="" Language="C#" MasterPageFile="~/Dialog.Master" AutoEventWireup="true" CodeBehind="AddFiles.aspx.cs" Inherits="Portal.Archive.AddFiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BoduCB" runat="server">
	<table dir="rtl" align="center" class="TableColor" width="80%">
		<tr class="RowHead">
			<td colspan="2" align="center">اضافه کردن فایل</td>
		</tr>
		<tr>
			<td>شاخه آرشیو</td>
			<td>
		...
		<asp:Repeater runat="server" ID="ViewDR" OnItemCommand="ViewDR_ItemCommand">
			<ItemTemplate>
				<tr class="<%# Container.ItemIndex % 2 == 0 ? "RowItem" : "RowAlter" %>">
					...
					<td align="center">
						<img style="width: 20px; height: 20px; cursor: pointer;" src="ییImages/References.png" onclick="window.location='/Archive/Access-<%# Eval("ArchiveFileID") %>.aspx';"
							alt="دسترسی" />
					</td>
					<%--<td align="center">
                        <img style="width:20px; height:20px;cursor:pointer;" src="ییImages/References.png" onclick="SelectPrepMsg('/Archive/AddFiles-<%# Eval("ArchiveFileID") %>.aspx',650,500);"
                            alt="نسخه جدید" />
                    </td>
					<td align="center">
                        <img style="width:20px; height:20px;cursor:pointer;" src="ییImages/References.png" onclick="SelectPrepMsg('/Archive/View-<%# Eval("ArchiveFileID") %>.aspx',650,500);"
                            alt="مشخصات فایل" />
                    </td>--%>
					<td align="center">
