<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDefault3.aspx.cs" Inherits="Portal.Admin.AdminDefault3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
	<table class="TableColor" align="center" style="width: 90%" border="0">
		<tr>
			<td colspan="4" align="center" valign="middle" style="height: 150px; background-color: #D4E4F1;">
				<asp:DropDownList ID="DL11" DataTextField="Name" DataValueField="DefaultItemID" runat="server">
				</asp:DropDownList>
			</td>
		</tr>
		<tr>
			<td colspan="4" align="center" valign="middle" style="background-color: #D4E4F1;">
		...
		<tr>
			<td align="center" style="height: 150px; background-color: #ECD4F1; width: 20%" valign="top">
			...
			<td align="center" style="height: 150px; background-color: #ECD4F1; width: 30%" valign="top">
