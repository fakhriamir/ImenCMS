<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Movies.aspx.cs" Inherits="Portal.Admin.Movies" %>
	...
	<table dir="<%=GetGlobalResourceObject("resource", "_Dir")%>" class="TableColor" align="center" id="Table1" cellspacing="0" cellpadding="1" width="80%">
		<tr>
			<td colspan="2" class="RowHead">
				<%=GetGlobalResourceObject("resource", "MovieMng")%>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<%=GetGlobalResourceObject("resource", "MovieSubject")%>
			</td>
			<td>
				<asp:DropDownList ID="MovieTypeDL" DataTextField="Name" DataValueField="MovieTypeID"
					runat="server">
				</asp:DropDownList>
				<a href="MovieTypes.aspx">
		...
		<tr>
			<td>
				<%=GetGlobalResourceObject("resource", "MovieTitle")%>
			</td>
			<td>
		...
		<tr>
			<td>
				<%=GetGlobalResourceObject("resource", "MovieDesc")%>
			</td>
			<td>
				  <CKEditor:CKEditorControl FormatSource="false" ID="textTB" Toolbar="Basic"  runat="server" Width="500px" Height="250px">
		...
		<tr>
			...
			<td>
				<asp:DropDownList ID="AddressDL" CssClass="NotSearch" runat="server" >
				</asp:DropDownList>
				*
			</td>
		</tr>
		...
		<asp:Repeater runat="server" ID="ViewDR" OnItemCommand="ViewDR_ItemCommand">
			<ItemTemplate>
				<tr class="<%# Container.ItemIndex % 2 == 0 ? "RowItem" : "RowAlter" %>">
					...
					<td align="center">
						&nbsp;<img src='<%=ADAL.A_CheckData.GetFilesRoot(true) %>/Images/Movies/<%# Eval("picname").ToString().Trim() %>' style="width:150px;"/>
					</td>
					<td align="center">
					...
					<td align="center">
						<asp:ImageButton ImageUrl="Imgs/edit.gif" Width="18px" Height="18px" CommandArgument='<%# Eval("MovieID").ToString().Trim() %>'
