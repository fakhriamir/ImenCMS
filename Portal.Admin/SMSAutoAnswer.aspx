<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="SMSAutoAnswer.aspx.cs" Inherits="Portal.Admin.SMSAutoAnswer" %>
		...
		<asp:Repeater ID="LogsDR" runat="server" OnItemCommand="ViewDR_ItemCommand">
			<ItemTemplate>
				<tr>
					...
					<td>
						<%# Eval("InText").ToString().Trim()%>
					</td>
					<td>
						<%#Eval("OutText").ToString().Trim()%>
					</td>
					<td align="center">
						<%# Eval("Active").ToString().Trim()%>
					</td>
					<td align="center">
