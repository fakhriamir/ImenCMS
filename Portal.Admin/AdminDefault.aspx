<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDefault.aspx.cs" Inherits="Portal.Admin.AdminDefault" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
	<table  class="TableColor" align=center style="width: 90%" border="1">
		<tr>
			<td colspan="3" align="center" valign="middle" style="height: 150px; background-color: #D4E4F1;">
				<asp:DropDownList ID="DL110" DataTextField="Name" DataValueField="DefaultItemID"
					runat="server">
				</asp:DropDownList>
			</td>
		</tr>
		<tr>
			<td colspan="3" align="center" valign="middle" style="background-color: #D4E4F1;">
				...
				<br />
				<asp:DropDownList ID="DL13" DataTextField="Name" DataValueField="DefaultItemID" runat="server">
				</asp:DropDownList>
				<br />
				<asp:DropDownList ID="DL14" DataTextField="Name" DataValueField="DefaultItemID" runat="server">
				</asp:DropDownList>
				<br />
			</td>
		</tr>
		<tr style="background-color: #D4F1F1; display: none">
			<td align="center">
			...
			<td align="center">
				<asp:DropDownList ID="DL23" DataTextField="Name" DataValueField="DefaultItemID" runat="server">
				</asp:DropDownList>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3" align="center">
				&nbsp;<asp:DropDownList ID="DL15" DataTextField="Name" DataValueField="DefaultItemID"
					runat="server">
				</asp:DropDownList>
