<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"   CodeBehind="PhoneBookAddType.aspx.cs" Inherits="Portal.Admin.PhoneBookAddType" %>
	...
	<table dir="<%=GetGlobalResourceObject("resource", "_Dir")%>" class="TableColor" align="center" id="Table1" cellspacing="0" cellpadding="1" width="80%">
		<tr>
			<td colspan="2" class="RowHead">
				<%=GetGlobalResourceObject("resource", "PhoneBookCatigory")%>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<asp:DropDownList ID="phonebooktypeidDL" runat="server" DataTextField="Name" DataValueField="PhoneBookTypeID">
				</asp:DropDownList>
				*
			</td>
		</tr>
		...
		<asp:Repeater runat="server" ID="ViewDR" OnItemCommand="ViewDR_ItemCommand">
			<ItemTemplate>
				<tr class="<%# Container.ItemIndex % 2 == 0 ? "RowItem" : "RowAlter" %>">
					<td align="center">
						&nbsp;<%# Eval("PhoneBookAddTypeID").ToString().Trim() %>
					</td>
					<td align="center">
					...
					<td align="center">
						<asp:ImageButton OnClientClick="return confirm_delete();" ImageUrl="Imgs/zarb.gif"
							Width="16px" Height="16px" CommandArgument='<%#Eval("PhoneBookAddTypeID").ToString().Trim() %>'
