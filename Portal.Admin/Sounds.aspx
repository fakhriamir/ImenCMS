<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Sounds.aspx.cs" Inherits="Portal.Admin.Sounds" %>
	...
	<table dir="<%=GetGlobalResourceObject("resource", "_Dir")%>" class="TableColor" align="center" id="Table1" cellspacing="0" cellpadding="1" width="80%">
		<tr>
			<td colspan="2" class="RowHead">
				<%=GetGlobalResourceObject("resource", "VoiceMng")%>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<asp:DropDownList ID="soundtypeidDL" DataTextField="name" DataValueField="soundtypeid"
					runat="server">
				</asp:DropDownList>
				<a href="SoundTypes.aspx">
		...
		<tr>
			...
			<td>
				  <CKEditor:CKEditorControl FormatSource="false" ID="textTB"  runat="server" >
                </CKEditor:CKEditorControl>
			</td>
		</tr>
		<tr>
			<td>
				<%=GetGlobalResourceObject("resource", "VoiceURL")%>
			</td>
			<td>
		...
		<asp:Repeater runat="server" ID="ViewDR"   OnItemCommand="ViewDR_ItemCommand">
			<ItemTemplate>
				<tr class="<%# Container.ItemIndex % 2 == 0 ? "RowItem" : "RowAlter" %>">
					...
					<td align="center">
						<asp:ImageButton ImageUrl="Imgs/edit.gif" Width="18px" Height="18px" CommandArgument='<%# Eval("SoundID").ToString().Trim() %>'
